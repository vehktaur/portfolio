  ...
  return (
    <main className='full-page'>
      <section className='padding-inline'>
        <div className='container flex flex-col items-center gap-4 sm:flex-row-reverse'>
          ...
          <AnimatePresence mode='wait'>
            ...
            >
              ...
              {/* project description */}
              <p className='max-w-[80ch] ~mb-4/7'>{project.description}</p>
              ...
              <div className='flex items-center gap-4'>
                <TooltipProvider>
                  <Tooltip delayDuration={100}>
                    <TooltipTrigger>
                      <Link
                        className='grid place-items-center rounded-full border transition-all duration-300 ~size-8/10 hover:scale-105'
                        href={project.live}
                        target='_blank'
                      >
